        ...
        <ol className={styles.description}>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                символы в строке только [0-9] и точка т.е. <b>число</b> в 10-ной системе счисления
                (возможно с плавающей запятой)
              </li>
            </ul>
            В случае ошибки валидации вызвать <i>handleError</i> с 'ValidationError' строкой в
            качестве аргумента
          </li>
          <li>
          ...
          <li>
            Взять кол-во символов в полученном от API числе <i>записать в writeLog</i>
          </li>
          <li>
          ...
          <li>
            C помощью API /animals.tech/id/name получить случайное животное используя полученный
            остаток в качестве id
          </li>
          <li>
            Завершить цепочку вызовом <i>handleSuccess</i> в который в качестве аргумента положить
...
GET / https://animals.tech/{id}`}
        ...
        <div className={styles.initSection}>
          ...
          <div className={styles.initButton}>
            <Button onClick={this.clearLog} variant='contained' color='secondary' size='small'>
              ✕
            </Button>
          </div>
        </div>
